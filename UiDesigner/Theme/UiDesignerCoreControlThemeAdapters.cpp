...
static void AddProgressOverrides(UiDesignerControlSpec& spec)
{
    ...
    AddNumeric(spec,"min_thickness","Minimum thickness","Appearance",s.min_thickness,1,256,true);
    Add(spec,"show_text","Show text","Appearance",PropertyEditorKind::Boolean,s.show_text,true);
