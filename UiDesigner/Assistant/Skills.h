...
Keep Theme changes separate from document structure and normal document Undo.
 ...
 {"data-v1", "Authored data", "Inspect data_capability, data_property and data_defaults in describe_control. Scalar configuration and List/Tree collection payloads differ. In prepare_composition, a UiList item may supply list_items: an array of at most 128 strings for its initial rows. This is a sibling of properties, not a property. Use it for requested list contents instead of leaving First/Second defaults. Other structured collection edits remain unsupported; explain that limit and direct the user to the Data editor."},
